...
//         __block NSString *filePath = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"scanned_image_%i.jpeg",(int)[NSDate date].timeIntervalSince1970]];

         __block NSString *filePath = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"scanned_image.png"]];

//         __block NSString *filePath2 = [NSTemporaryDirectory() stringByAppendingPathComponent:[NSString stringWithFormat:@"d2ascanned_image_%i.jpeg",(int)[NSDate date].timeIntervalSince1970]];
         ...
         @autoreleasepool
         {
             ...
             UIImage *output_image= [[UIImage alloc]initWithCGImage:imgRef ];
             UIImageWriteToSavedPhotosAlbum(output_image,nil,nil,nil);
             saveCGImageAsJPEGToFilePath(imgRef, filePath);
//             saveCGImageAsJPEGToFilePath(imgRef, filePath2);
             CFRelease(imgRef);
